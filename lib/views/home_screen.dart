            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      icon: (productController.isOneList.value = false) ? const Icon(Icons.view_list_rounded):const Icon(Icons.grid_view),
                      onPressed: () {
                        productController.isOneList.value = !productController.isOneList.value;
                      }),
                ],
              ),
            ),
